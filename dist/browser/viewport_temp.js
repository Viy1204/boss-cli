...
function resolvedTempHeightPx(heightPx) {
...
function dimensionsForTempHeight(prev, heightPx) {
...
function dimensionsAfterResume(prev) {
    if (prev) {
        return prev;
    }
 ...
 */
export async function snapshotBossPageViewport(page) {
