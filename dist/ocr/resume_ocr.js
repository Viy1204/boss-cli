 ...
 */
export async function ocrResumePngToTextFile(pngAbsPath) {
    ensureAppDataLayout();
    if (!isBaiduOcrConfigured()) {
        throw new Error('已开启简历 OCR（BOSS_RESUME_OCR），但未配置百度密钥：请设置 API_KEY 与 SECRET_KEY（或 BOSS_BAIDU_API_KEY / BOSS_BAIDU_SECRET_KEY）。');
    }
...
//# sourceMappingURL=resume_ocr.js.map